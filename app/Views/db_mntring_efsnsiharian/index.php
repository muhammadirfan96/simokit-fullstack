...
<div class="card mb-4">
    <div class="card-body">
        <table id="datatablesSimple">
            ...
            <tbody>
                <?php $i = 0 ?>
                <?php foreach ($mntring_efsnsiharian as $row) : ?>
                    <tr>
                        <td style="width: 1%;">
                            ...
                            <button class="btn btn-sm text-white bg_merah0 fst-italic" type="button" onclick="return konfir('db_mntring_efsnsiharian','delete','<?= $row['id']; ?>',null)" style="width: 70px;">delete</button>
                        </td>
                        <td><?= $row["nama_file"]; ?></td>
